...
\subsection{Window Sampling} \label{window_samp}
...
\subsection{Poisson Process for stopping points} \label{window_samp}
...
\begin{figure}[H]
\center
\includegraphics[width=13cm]{figures/probOneDoc.jpg}
